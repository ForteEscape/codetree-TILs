...
public class Main {
	...
	public static void init(int n, int m, List<Integer> infoList) {
		graph = new ArrayList<>();
	...
	public static void create(int id, int revenue, int dest) {
	...
	public static void changeStartingPoint(int nextStartingPoint) {
